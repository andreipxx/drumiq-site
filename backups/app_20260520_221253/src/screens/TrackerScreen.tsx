...
export default function TrackerScreen() {
  ...
  return (
    ...
    >
              ...
              {chartData.map((d, i) => {
                ...
                return (
                  <View key={i} style={st.chartBarWrap}>
                    {d.earnings > 0 && (
                      <Text style={[st.chartBarValue, { color: d.isToday ? colors.accent : colors.textMuted }]}>
                    ...
                    <View style={[
                      ...
                      {
                        height: `${heightPct}%`,
                        backgroundColor: d.isToday ? colors.accent : colors.accentDim,
                        ...(d.isToday ? {
                          shadowColor: colors.accent,
                          shadowOpacity: 0.5,
                          shadowRadius: 8,
                    ...
                    <Text style={[st.chartBarDay, { color: d.isToday ? colors.accent : colors.textDim }]}>
                      {d.label}
                    </Text>
                  </View>
                );
      ...
      {/* Ride list */}
      <Text style={[st.sectionLbl, { color: colors.textMuted, marginTop: 16 }]}>CURSE INDIVIDUALE</Text>
      {rides.length === 0 ? (
